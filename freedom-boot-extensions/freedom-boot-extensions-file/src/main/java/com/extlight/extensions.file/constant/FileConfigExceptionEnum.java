...
public enum FileConfigExceptionEnum implements GlobalExceptionMap {
    ...
    ERROR_RESOURCE_NOT_EXIST(5101, "资源不存在"),
    ERROR_UPLOAD_DIR_IS_EMPTY(5102, "文件上传目录为空，请在【文件配置】中设置再进行操作"),
    ERROR_QN_CONFIG_IS_EMPTY(5103, "七牛云配置不完全，请在【文件配置】中设置再进行操作"),
    ERROR_OSS_CONFIG_IS_EMPTY(5104, "OSS 配置不完全，请在【文件配置】中设置再进行操作"),
	;
