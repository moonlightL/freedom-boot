var PermissionUI = (function ($) {

    var PermissionUI = function (url, permissions) {
        this.url = url;
        this.permissions = permissions;
    }

    PermissionUI.prototype.init = function () {
        this.initModules(this.url);
        this.initMenus(this.url, this.permissions);
        this.bindEvent();
    }


    PermissionUI.prototype.initModules = function (url) {
    ...
    PermissionUI.prototype.initMenus = function (url, permissions) {
    ...
    PermissionUI.prototype.bindEvent = function () {
        var state = false;
