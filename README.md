...
目录结构分层明了，便于维护、扩展开发
代码高度抽象，约定大于配置
内置权限管理功能，灵活控制模块、菜单以及页面按钮
内部扩展代码生成器功能，帮助开发者生成前后端代码文件，大大节省 70% 开发时间
内部扩展系统监控功能，方便用户查看和监控服务器相关信息
内部扩展文件管理功能，集成七牛云、OSS 对象管理工具
前端封装 freedom-core 工具，方便灵活易用，是不熟练前端技术的开发者的福音
```

## 项目功能

```
用户管理：提供用户数据管理以及角色授权功能
角色管理：提供角色数据管理以及权限授权功能
权限管理：提供权限数据管理功能
日志管理：提供用户操作日志查询功能
