...
INSERT INTO `t_sys_permission` (`id`, `name`, `icon`, `url`,`module_code`, `per_type`, `resource_type`, `per_code`, `pid`, `state`, `sort`, `is_common`) VALUES
 ...
 (4, '编辑', 'fa fa-edit', '', '', 3, 1, 'core:user:update', 2, 1, 2, 1),
 (5, '删除', 'fa fa-trash', '', '', 3, 1, 'core:user:remove', 2, 1, 3, 1),
 (6, '查询', 'fa fa-search', '', '', 3, 1, 'core:user:query', 2, 1, 4, 1),
 (7, '分配角色', 'fa fa-role', '', '', 3, 1, 'core:user:assign:role', 2, 1, 5, 0),
 (8, '角色管理', 'fa fa-user-secret', '/core/role/listUI.html', '', 2, 1, 'core:role:listUI', 1, 1, 2, 1),
 (9, '新增', 'fa fa-plus-circle', '', '', 3, 1, 'core:role:save', 8, 1, 1, 1),
 (10, '编辑', 'fa fa-edit', '', '', 3, 1, 'core:role:update', 8, 1, 2, 1),
 (11, '删除', 'fa fa-trash', '', '', 3, 1, 'core:role:remove', 8, 1, 3, 1),
 (12, '查询', 'fa fa-search', '', '', 3, 1, 'core:role:query', 8, 1, 4, 1),
 (13, '分配权限', 'fa fa-permission', '', '', 3, 1, 'core:role:assign:permission', 8, 1, 5, 0),
 (14, '权限管理', 'fa fa-crosshairs', '/core/permission/listUI.html', '', 2, 1, 'core:permission:listUI', 1, 1, 3, 1),
 (15, '新增', 'fa fa-plus-circle', '', '', 3, 1, 'core:permission:save', 14, 1, 1, 1),
 (16, '编辑', 'fa fa-edit', '', '', 3, 1, 'core:permission:update', 14, 1, 2, 1),
 (17, '删除', 'fa fa-trash', '', '', 3, 1, 'core:permission:remove', 14, 1, 3, 1),
 (18, '日志管理', 'fa fa-monitor', '/core/log/listUI.html', '', 2, 1, 'core:log:listUI', 1, 1, 4, 1),
 (19, '查询', 'fa fa-search', '', '', 3, 1, 'core:log:query', 18, 1, 1, 1),
 (20, '代码管理', 'fa fa-code', '', 'GENERATOR', 1, 2, '', 0, 1, 2, 1),
 (21, '数据表管理', 'fa fa-user', '/generator/table/listUI.html', '', 2, 2, 'generator:table:listUI', 20, 1, 1, 1),
 (22, '系统监控', 'fa fa-eye', '', 'MONITOR', 1, 2, '', 0, 1, 3, 1),
 (23, '系统信息', 'fa fa-server', '/monitor/server/listUI.html', '', 2, 2, 'monitor:server:listUI', 22, 1, 1, 1),
 (24, 'SQL监控', 'fa fa-sql', '/druid/index.html', '', 2, 2, 'monitor:druid:index', 22, 1, 1, 1),
 (25, '文件管理', 'fa fa-file', '', 'FILE', 1, 2, '', 0, 1, 4, 1),
 (26, '文件上传', 'fa fa-upload', '/file/data/listUI.html', '', 2, 2, 'file:data:listUI', 25, 1, 1, 1),
 (27, '上传', 'fa fa-cloud-upload', '', '', 3, 2, 'file:data:save', 26, 1, 1, 1),
 (28, '删除', 'fa fa-trash', '', '', 3, 2, 'file:data:remove', 26, 1, 2, 1),
 (29, '查询', 'fa fa-search', '', '', 3, 2, 'file:data:query', 26, 1, 3, 1),
 (30, '下载', 'fa fa-cloud-download', '', '', 3, 2, 'file:data:download', 26, 1, 4, 1),
 (31, '文件配置', 'fa fa-config', '/file/config/listUI.html', '', 2, 2, 'file:config:listUI', 25, 1, 1, 1),
 (32, '保存', 'fa fa-save', '', '', 3, 2, 'file:config:save', 31, 1, 1, 1);
