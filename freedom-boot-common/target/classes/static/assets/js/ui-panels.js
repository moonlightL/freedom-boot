...
// - ThemeOn.net -
 ...
 $(document).ready(function() {
    ...
    // =================================================================
    $('.freedom-panel-ref-btn').niftyOverlay().on('click', function(){
        var $el = $(this), relTime;
    ...
    // http://www.themeon.net/
    // =================================================================
    $('#freedom-panel-alert').on('click', function(){
        $.niftyNoty({
            type: 'primary',
            container : '#freedom-panel-w-alert',
    ...
    // http://www.themeon.net/
    // =================================================================
    $('#freedom-panel-alert2').on('click', function(){
        $.niftyNoty({
            type: 'warning',
            container : '#freedom-panel-w-alert',
            html : '<strong>Well done!</strong> You successfully read this important alert message.',
