...
$(document).ready(function() {
    ...
    jQuery.fn.bootstrapTable.defaults.icons = {
        paginationSwitchDown: 'freedom-pli-arrow-down',
        paginationSwitchUp: 'freedom-pli-arrow-up',
        refresh: 'freedom-pli-repeat-2',
        toggle: 'freedom-pli-layout-grid',
        columns: 'freedom-pli-check',
        detailOpen: 'freedom-psi-add',
        detailClose: 'freedom-psi-remove'
    }
    ...
    // http://bootstrap-table.wenzhixin.net.cn/
    // =================================================================
    $('#freedom-editable').bootstrapTable({
        idField: 'id',
    ...
    // http://bootstrap-table.wenzhixin.net.cn/
    // =================================================================
    var $table = $('#freedom-custom-toolbar'),	$remove = $('#freedom-delete-row');
