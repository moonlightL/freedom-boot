...
// - ThemeOn.net -
 ...
 $(document).ready(function() {
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#freedom-bootbox-alert').on('click', function(){
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#freedom-bootbox-confirm').on('click', function(){
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#freedom-bootbox-prompt').on('click', function(){
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#freedom-bootbox-custom').on('click', function(){
        bootbox.dialog({
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#freedom-bootbox-custom-h-content').on('click', function(){
        bootbox.dialog({
            title: "That html",
    ...
    // http://bootboxjs.com/
    // =================================================================
    $('#freedom-bootbox-custom-h-form').on('click', function(){
        bootbox.dialog({
            ...
            message:'<div class="row"> ' + '<div class="col-md-12"> ' +
                    ...
                    '<label class="form-radio form-icon freedom-modal-radio active"><input type="radio" autocomplete="off" name="awesomeness" value="Really awesome" checked> Really awesome</label>' +
                    '<label class="form-radio form-icon freedom-modal-radio"><input type="radio" autocomplete="off" name="awesomeness" value="Super awesome"> Super awesome </label> </div>' +
        ...
        $(".freedom-modal-radio").niftyCheck();
    });
    ...
    // =================================================================
    $('#freedom-bootbox-zoom').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#freedom-bootbox-bounce').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#freedom-bootbox-ruberwobble').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#freedom-bootbox-flip').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#freedom-bootbox-lightspeed').on('click', function(){
        bootbox.confirm({
    ...
    // http://daneden.github.io/animate.css/
    // =================================================================
    $('#freedom-bootbox-swing').on('click', function(){
        bootbox.confirm({
