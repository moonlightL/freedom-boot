...
// - ThemeOn.net -
 ...
 $(document).ready(function() {
    ...
    gauge.setTextField(document.getElementById("freedom-gauge-txt"));
    ...
    // =================================================================
    var updateGauge;
    var gaugeSwitch = document.getElementById('freedom-auto-gauge');
    ...
    var hddSparkline = function() {
        $("#freedom-sparkline-area").sparkline([57,69,70,62,73,79,76,77,73,52,57,50,60,55,70,68], {
            type: 'line',
            width: '100%',
            height: '40',
            spotRadius: 5,
    ...
    var earningSparkline = function(){
        $("#freedom-sparkline-line").sparkline([345,404,305,455,378,567,586,685,458,742,565], {
            type: 'line',
            width: '100%',
            height: '40',
            spotRadius: 4,
    ...
    // http://omnipotent.net/jquery.sparkline/#s-about
    // =================================================================
    var barEl = $("#freedom-sparkline-bar");
    ...
    // http://omnipotent.net/jquery.sparkline/#s-about
    // =================================================================
    $("#freedom-sparkline-pie").sparkline([5, 12, 17 ,55], {
        type: 'pie',
        width: '55',
        height: '55',
    ...
    var plot = $.plot("#freedom-flot-line", [
            {
                label: 'Pageviews',
                data: pageviews,
                lines: {
    ...
    // Flot tooltip
    // =================================================================
    $("<div id='freedom-flot-tooltip'></div>").css({
        position: "absolute",
        display: "none",
        padding: "10px",
        color: "#fff",
    ...
    $("#freedom-flot-line").bind("plothover", function (event, pos, item) {

        if (item) {
            var x = item.datapoint[0].toFixed(2),  y = item.datapoint[1];
            $("#freedom-flot-tooltip").html("<p class='h4'>" + item.series.label + "</p>" + y)
                .css({top: item.pageY+5, left: item.pageX+5})
                .fadeIn(200);
        } else {
            $("#freedom-flot-tooltip").hide();
        }
    ...
    $.plot('#freedom-flot-donut', dataSet, {
        series: {
            pie: {
                show: true,
                combine: {
