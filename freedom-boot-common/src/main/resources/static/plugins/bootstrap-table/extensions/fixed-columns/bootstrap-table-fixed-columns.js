(function (global, factory) {
	...
	*/
	...
	var MAXIMUM_ALLOWED_INDEX_EXCEEDED = 'Maximum allowed home exceeded';
	...
	function (_$$BootstrapTable) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function initFixedColumnsEvents() {
	      ...
	      this.$body.find('> tr[data-home]').off('hover').hover(function (e) {
	        var index = $(e.currentTarget).data('index');

	        _this.$fixedBody.find("tr[data-home=\"".concat(index, "\"]")).css('background-color', $(e.currentTarget).css('background-color'));
	      }, function (e) {
	        var index = $(e.currentTarget).data('index');

	        var $tr = _this.$fixedBody.find("tr[data-home=\"".concat(index, "\"]"));

	        $tr.attr('style', $tr.attr('style').replace(/background-color:.*;/, ''));
	      });
	      this.$fixedBody.find('tr[data-home]').off('hover').hover(function (e) {
	        var index = $(e.currentTarget).data('index');

	        _this.$body.find("tr[data-home=\"".concat(index, "\"]")).css('background-color', $(e.currentTarget).css('background-color'));
	      }, function (e) {
	        var index = $(e.currentTarget).data('index');

	        var $tr = _this.$body.find("> tr[data-home=\"".concat(index, "\"]"));
