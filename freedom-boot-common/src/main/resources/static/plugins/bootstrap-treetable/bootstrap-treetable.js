...
(function($) {
        ...
        if (self.options.url) {
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR) {
                    data = self.options.responseHandler(data);
    ...
    // 刷新数据
    BootstrapTreeTable.prototype.refresh = function() {
        var self = this;
        self.destroy();
        self.init(this.options.queryParams);
    };
    // 刷新选项
    BootstrapTreeTable.prototype.refreshOptions = function(options) {
        var self = this;
        self.options = $.extend(self.options, options);
        self.destroy();
        self.init(options.queryParams);
    };
    // 获取选项
    BootstrapTreeTable.prototype.getOptions = function() {
    ...
    BootstrapTreeTable.DEFAULTS = {
        ...
        toolRefreshClass: 'glyphicon glyphicon-refresh icon-refresh', // 工具栏刷新按钮
