...
a){var c=d.cells(a,":hidden").eq(0).map(function(a){var c=e(d.column(a.column).header()),a=d.cell(a).index();if(c.hasClass("control")||c.hasClass("never"))return"";var g=d.settings()[0],g=g.oApi._fnGetCellData(g,a.row,a.column,"display");return'<li data-dtr-home="'+a.column+'"><span class="dtr-title">'+c.text()+':</span> <span class="dtr-data">'+g+"</span></li>"}).toArray().join("");return c?e('<ul data-dtr-home="'+a+'"/>').append(c):!1},target:0,type:"inline"}};var l=e.fn.dataTable.Api;l.register("responsive()",
function(){return this});l.register("responsive.recalc()",function(){this.iterator("table",function(d){d._responsive&&(d._responsive._resizeAuto(),d._responsive._resize())})});l.register("responsive.home()",function(d){d=e(d);return{column:d.data("dtr-home"),row:d.parent().data("dtr-home")}});h.version="1.0.2";e.fn.dataTable.Responsive=h;e.fn.DataTable.Responsive=h;e(o).on("init.dt.dtr",function(d,a){if(e(a.nTable).hasClass("responsive")||e(a.nTable).hasClass("dt-responsive")||a.oInit.responsive||
