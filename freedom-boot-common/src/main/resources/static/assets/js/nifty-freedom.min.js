$(document).ready(function() {
    function l() {
        ...
        a.hasClass("boxed-layout") ? (n.checked = !0) : (n.checked = !1),
            n.onchange = function() {
                n.checked ? (a.addClass("boxed-layout")) : (a.removeClass("boxed-layout").removeAttr("style"), l.removeClass("open").find(".thumbnail").removeClass("selected")),
                    $(window).trigger("resize")
            };
        var y = document.getElementById("freedom-navbar-fixed");
        ...
        var C = document.getElementById("freedom-footer-fixed");
        ...
        var b = document.getElementById("freedom-nav-coll"),
            T = document.getElementById("freedom-nav-fixed"),
            x = document.getElementById("freedom-nav-profile"),
            S = document.getElementById("freedom-nav-shortcut"),
            k = $("#mainnav-profile"),
            E = $("#mainnav-shortcut");
        T.checked = a.hasClass("mainnav-fixed") ? !0 : !1,
            ...
            b.onchange = function() {
                b.checked ? ($.niftyNav("collapse")) : $.niftyNav("expand")
            };
        var I = function() {
        ...
        var _ = document.getElementById("freedom-asd-vis"),
            N = document.getElementById("freedom-asd-fixed"),
            A = document.getElementById("freedom-asd-float"),
            H = document.getElementById("freedom-asd-align"),
