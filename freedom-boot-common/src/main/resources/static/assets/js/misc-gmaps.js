...
$(document).ready(function() {
	...
	var geomap = new GMaps({
		div: '#freedom-geocoding-map',
		lat: -12.043333,
		lng: -77.028333
	});

	$('#freedom-geocoding-form').submit(function(e){
		e.preventDefault();
		GMaps.geocode({
			address: $('#freedom-geocoding-address').val().trim(),
